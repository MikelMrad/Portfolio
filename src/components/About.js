...
export default function About() {
  return (
    <section className={styles.Page}>
      ...
      <AboutContainer src={EST} header={"Front-End Developer"} paragraph={"With my diploma in hand, I secured a full-time position as a Front-End Developer."} date={"June 2025 - Present"}/>
    </section>
  )
}
